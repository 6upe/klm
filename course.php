                ...
                <div class="navbar-nav mx-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="" class="dropdown-item">Minerals</a>
                            <a href="" class="dropdown-item">Gemstones</a>
                            <a href="" class="dropdown-item">Hardware</a>
                            <a href="course.html" class="dropdown-item">Other</a>
                            <!-- <a href="testimonial.html" class="dropdown-item"></a> -->
                        </div>
                    </div>
                    <a href="" class="nav-item nav-link ">Admin</a>
                </div>
                <a href="" class="btn btn-primary py-2 px-4 d-none d-lg-block">Chat with us!</a>
        ...
        <div class="row mx-0 justify-content-center pt-5">
            <div class="col-lg-6">
                <div class="section-title text-center position-relative mb-4">
                    <h6 class="d-inline-block position-relative text-white fw-bold text-uppercase pb-2">Our Products</h6>
                    <h1 class="display-4 text-white">Checkout New products on the Market</h1>
                </div>
            </div>
        </div>
    </div>
